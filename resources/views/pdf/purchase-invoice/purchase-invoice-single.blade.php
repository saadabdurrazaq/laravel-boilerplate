  ...
  <div>
      ...
      <tr>
        ...
        <td width="90%" align="right">
          <table width="100%" cellspacing="0" cellpadding="5" border="0">
            <tr>
              <td>
                <p class="header" style="text-align: right;"><b>PURCHASE INVOICE</b></p>
              </td>
            </tr>
          </table>
        </td>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin-top: 25px; font-size: 14px">
      <tr>
        ...
        <td style="background-color: #0877BB; color: white;">
          <p class="table-header-padding">Order Date</p>
        </td>
        <td style="background-color: #0877BB; color: white;">
      ...
      @foreach ($purchase_order_details as $index => $purchase_order_detail)
        <tr>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['purchase_order_number'] }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['buyer_po_number'] ?? '-' }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['purchase_order_date'] }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['style_code'] ?? '-' }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['style_name'] ?? '-' }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['item_code'] }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['item_name'] }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ $purchase_order_detail['unit_name'] }}</p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($purchase_order_detail['qty'], 3) }}
            </p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($purchase_order_detail['price'], 3) }}
            </p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($purchase_order_detail['amount'], 3) }}</p>
          </td>
        </tr>
      @endforeach
    </table>
