      ...
      <tr>
        ...
        <td width="90%" align="right">
          <table width="100%" cellspacing="0" cellpadding="5" border="0">
            <tr>
              <td>
                <p class="header" style="text-align: right;"><b>SHIPPING</b></p>
              </td>
            </tr>
          </table>
        </td>
        ...
        <tr>
          ...
          <td>
            <table width="100%" cellspacing="0" cellpadding="0" border="1">
              <tr>
                <td>
                  <p class="table-header-padding">{{ $color['unit']['name'] }}</p>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width="100%" cellspacing="0" cellpadding="0" border="1">
              <tr>
                <td>
                  <p class="table-header-padding">{{ $color['color'] }}</p>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width="100%" cellspacing="0" cellpadding="0" border="1">
              <tr>
                <td>
                  <p class="table-header-padding">{{ $color['shipping_qty'] }}</p>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width="100%" cellspacing="0" cellpadding="0" border="1">
              <tr>
                <td>
                  <p class="table-header-padding">{{ $color['unit_price'] }}</p>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width="100%" cellspacing="0" cellpadding="0" border="1">
              <tr>
                <td>
                  <p class="table-header-padding">{{ $color['amount'] }}</p>
                </td>
              </tr>
            </table>
          </td>
              ...
              <td>
                <table width="100%" cellspacing="2" cellpadding="2" border="1">
                  <tr>
                    ...
                    <td>
                      <p style="text-align: left; min-width: 150px; padding-left: 8px">
                        {{ $total_amount }}
                      </p>
                    </td>
                  </tr>
            ...
            <tr>
              ...
              <td>
                <table width="100%" cellspacing="2" cellpadding="2" border="1"
                  ...
                  <tr>
                    <p style="text-align: left; color: white; padding-left: 8px">
                      {{ $grand_total }}
                    </p>
                  </tr>
                </table>
