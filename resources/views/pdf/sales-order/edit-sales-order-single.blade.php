  ...
  <div>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin-top: 25px; font-size: 14px">
      ...
      <tr>
        ...
        <td>
          <p class="table-header-padding">{{ $total_discount }}</p>
        </td>
        <td>
          <p class="table-header-padding">-</p>
        </td>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin-top: 25px; font-size: 14px">
      ...
      @foreach ($styles as $style_index => $style)
        <tr>
          ...
          <td>
            <p class="table-header-padding">{{ $style['unit']['name'] ?? $style['unit_name'] }}</p>
          </td>
          <td>
            <p class="table-header-padding">{{ formatNumberRupiah($style['qty'], 3) }}</p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($style['discount'], 3) }}
            </p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
        ...
        <tr>
          <td colspan="8">
            <table width="100%" cellspacing="0" cellpadding="0" style="font-size: 14px">
              ...
              @foreach ($style['color_methods']['data'] as $cm_index => $colorMethod)
                <tr style="background-color: white; color: black; border: none">
                  <td>
                    <p class="table-header-padding">{{ $colorMethod['name'] }}</p>
                  </td>
                  <td>
                    <p class="table-header-padding">
                      @foreach ($colorMethod['colors'] as $color)
                        {{ $color['name'] }} ({{ $color['qty'] }}) @if (!$loop->last)
                          -
                        @endif
                      @endforeach
                    </p>
                  ...
                  <td>
                    <p class="table-header-padding">{{ formatNumberRupiah($colorMethod['qty'], 3) }}</p>
                  </td>
                  <td>
                    <p class="table-header-padding">{{ formatNumberRupiah($colorMethod['total_high_price'], 3) }}</p>
                  </td>
                  <td>
                    <p class="table-header-padding">{{ formatNumberRupiah($colorMethod['total_low_price'], 3) }}</p>
                  </td>
                </tr>
              @endforeach
            </table>
            ...
            <tr>
              <td>
                <p style="font-size: 14px;">
                    @if($remark!=null){{ $remark }}@else {{"-"}} @endif
                </p>
              </td>
            </tr>
          </table>
