    ...
    @foreach ($items as $item_index => $item)
      <table width="100%" cellspacing="0" cellpadding="0" border="1"
        ...
        <tr>
          ...
          <td>
            <p class="table-header-padding">{{ $item['unit_name'] }}</p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">{{ $item['qty'] }}</p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ $item['discount'] }} %
          ...
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($item['high_amount'], 3) }}
            </p>
          </td>
          <td>
            <p class="table-header-padding" style="text-align: right !important;">
              {{ formatNumberRupiah($item['amount'], 3) }}
            </p>
          </td>
        </tr>
